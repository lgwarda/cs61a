...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    total, count, piged_out = 0, 0, False
...
def pig_pass(player_score, opponent_score):
    ...
    return score_diff < 3 and score_diff > 0
    # END PROBLEM 4b
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if who == 0:
            ...
            curr_score = score1
        score_ranges = curr_score - last_score
        if score_ranges > alt:
            alt = score_ranges
            print(score_ranges, "point(s)! The most yet for Player", who)
        return announce_highest(who, curr_score, alt)
    return say
    # END PROBLEM 7
